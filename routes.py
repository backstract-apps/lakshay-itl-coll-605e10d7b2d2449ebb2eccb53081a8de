...
@router.get('/get-params', response_model=schemas.Persons)
def get_persons_by_rollnumber(first_name: str, roll_number: int, db: Session = Depends(get_db)):
    return crud_service.get_persons_by_rollnumber(db, first_name, roll_number)
